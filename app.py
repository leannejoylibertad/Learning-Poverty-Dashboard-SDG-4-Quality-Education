...
f'<div class="priority-stat-lbl">avg gov. expenditure per student vs model coefficient (p = 0.001)</div>'
f'<div class="priority-card-body">Gov. expenditure is a significant negative predictor <b>(β = −3.64, p = 0.001)</b> — but spending without targeting foundational grades has weak ROI. <b>Allocation quality matters as much as quantity.</b> Caution: panel autocorrelation detected in the model (Durbin-Watson = 0.434); interpret coefficient magnitudes directionally.</div>'
...
f'<div class="priority-card-body">Multiple countries show missing LP data for recent years, requiring imputation during analysis. This same scarcity contributes to panel autocorrelation (Durbin-Watson = 0.434), limiting model precision. Without annual, standardized assessments aligned to PIRLS/EGRA standards, governments cannot course-correct in time. <b>Invisible problems cannot be solved.</b></div>'
